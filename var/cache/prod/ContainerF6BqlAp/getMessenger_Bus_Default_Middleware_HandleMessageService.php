...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelProdContainer
{
    ...
    {
        $container->privates['messenger.bus.default.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\ScheduleJobs\\Message' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.H_0oGie'] ?? $container->load('get_Messenger_HandlerDescriptor_H0oGieService'));
