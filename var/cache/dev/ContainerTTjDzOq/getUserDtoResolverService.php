 ...
 */
class getUserDtoResolverService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private '.debug.value_resolver.App\DTOResolvers\UserDtoResolver' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DTOResolvers'.\DIRECTORY_SEPARATOR.'UserDtoResolver.php';

        return $container->privates['.debug.value_resolver.App\\DTOResolvers\\UserDtoResolver'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \App\DTOResolvers\UserDtoResolver(($container->privates['debug.serializer'] ?? self::getDebug_SerializerService($container))), ($container->services['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    }
}
