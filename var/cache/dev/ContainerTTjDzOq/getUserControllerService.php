...
class getUserControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['App\\Controller\\UserController'] = $instance = new \App\Controller\UserController(($container->privates['App\\Service\\Impl\\UserServiceImpl'] ?? $container->load('getUserServiceImplService')), ($container->privates['App\\Service\\Impl\\CacheServiceImpl'] ?? $container->load('getCacheServiceImplService')), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
