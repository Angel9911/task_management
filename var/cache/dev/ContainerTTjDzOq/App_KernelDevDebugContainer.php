...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\DeffController' => 'getDeffControllerService',
            'App\\Controller\\ErrorLogController' => 'getErrorLogControllerService',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $a->pushHandler(($container->privates['monolog.handler.info'] ?? self::getMonolog_Handler_InfoService($container)));
        $a->pushHandler(($container->privates['monolog.handler.warning'] ?? self::getMonolog_Handler_WarningService($container)));
        ...
        $instance->add($container->load('getGosWebSocket_DataCollector_WebsocketService'));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.8zx.G5r'] ?? self::get_CacheConnection_8zx_G5rService($container)), '2m89bLFB6A', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gJ+CK1KcZR', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FE1ZXDpSmo', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zimuth7DLw', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDataCollector_CacheService($container)
    {
        ...
        $instance->addInstance('my_redis_pool', ($container->privates['my_redis_pool'] ?? self::getMyRedisPoolService($container)));
    ...
    protected static function getDoctrine_Dbal_DefaultConnectionService($container)
    {
        ...
        $c->pushHandler(($container->privates['monolog.handler.info'] ?? self::getMonolog_Handler_InfoService($container)));
        $c->pushHandler(($container->privates['monolog.handler.warning'] ?? self::getMonolog_Handler_WarningService($container)));
        $c->pushHandler(($container->privates['monolog.handler.error'] ?? self::getMonolog_Handler_ErrorService($container)));
        ...
        $container->services['doctrine.dbal.default_connection'] = $instance = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([], new \Doctrine\DBAL\Tools\DsnParser(['db2' => 'ibm_db2', 'mssql' => 'pdo_sqlsrv', 'mysql' => 'pdo_mysql', 'mysql2' => 'pdo_mysql', 'postgres' => 'pdo_pgsql', 'postgresql' => 'pdo_pgsql', 'pgsql' => 'pdo_pgsql', 'sqlite' => 'pdo_sqlite', 'sqlite3' => 'pdo_sqlite'])))->createConnection(['driver' => 'pdo_pgsql', 'charset' => 'UTF8', 'url' => $container->getEnv('resolve:DATABASE_URL'), 'use_savepoints' => true, 'idle_connection_ttl' => 600, 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'serverVersion' => '13', 'defaultTableOptions' => ['charset' => 'utf8', 'collate' => 'utf8_unicode_ci']], $b, $a, []);
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('task.assigned', [#[\Closure(name: 'App\\private_lib\\listeners\\EmailNotificationTask')] fn () => ($container->privates['App\\private_lib\\listeners\\EmailNotificationTask'] ?? $container->load('getEmailNotificationTaskService')), 'onTaskAssigned'], 0);
        $instance->addListener('task.assigned', [#[\Closure(name: 'App\\private_lib\\listeners\\ViberNotificationTask')] fn () => ($container->privates['App\\private_lib\\listeners\\ViberNotificationTask'] ?? $container->load('getViberNotificationTaskService')), 'onTaskAssigned'], 0);
        ...
        $instance->addListener('gos_web_socket.client_connected', [#[\Closure(name: 'gos_web_socket.event_listener.client', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\ClientEventListener')] fn () => ($container->privates['gos_web_socket.event_listener.client'] ?? $container->load('getGosWebSocket_EventListener_ClientService')), 'onClientConnect'], 0);
        $instance->addListener('gos_web_socket.client_disconnected', [#[\Closure(name: 'gos_web_socket.event_listener.client', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\ClientEventListener')] fn () => ($container->privates['gos_web_socket.event_listener.client'] ?? $container->load('getGosWebSocket_EventListener_ClientService')), 'onClientDisconnect'], 0);
        $instance->addListener('gos_web_socket.client_error', [#[\Closure(name: 'gos_web_socket.event_listener.client', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\ClientEventListener')] fn () => ($container->privates['gos_web_socket.event_listener.client'] ?? $container->load('getGosWebSocket_EventListener_ClientService')), 'onClientError'], 0);
        $instance->addListener('gos_web_socket.client_rejected', [#[\Closure(name: 'gos_web_socket.event_listener.client', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\ClientEventListener')] fn () => ($container->privates['gos_web_socket.event_listener.client'] ?? $container->load('getGosWebSocket_EventListener_ClientService')), 'onClientRejected'], 0);
        ...
        $instance->addListener('gos_web_socket.server_launched', [#[\Closure(name: 'gos_web_socket.event_listener.register_periodic_timers', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\RegisterPeriodicTimersListener')] fn () => ($container->privates['gos_web_socket.event_listener.register_periodic_timers'] ?? $container->load('getGosWebSocket_EventListener_RegisterPeriodicTimersService')), 'registerPeriodics'], 0);
        $instance->addListener('gos_web_socket.server_launched', [#[\Closure(name: 'gos_web_socket.event_listener.register_push_handlers', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\RegisterPushHandlersListener')] fn () => ($container->privates['gos_web_socket.event_listener.register_push_handlers'] ?? $container->load('getGosWebSocket_EventListener_RegisterPushHandlersService')), 'registerPushHandlers'], 0);
        $instance->addListener('gos_web_socket.server_launched', [#[\Closure(name: 'gos_web_socket.event_listener.start_server', class: 'Gos\\Bundle\\WebSocketBundle\\EventListener\\StartServerListener')] fn () => ($container->privates['gos_web_socket.event_listener.start_server'] ?? $container->load('getGosWebSocket_EventListener_StartServerService')), 'bindPnctlEvent'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\SecurityController', 'App\\Controller\\DeffController', 'App\\Controller\\ErrorLogController', 'App\\Controller\\TaskController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
        ...
        return $container->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel($a, new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver($b, $c), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () use ($container) {
            ...
            yield 8 => ($container->privates['.debug.value_resolver.App\\DTOResolvers\\UserDtoResolver'] ?? $container->load('getUserDtoResolverService'));
            yield 9 => ($container->privates['.debug.value_resolver.App\\DTOResolvers\\TaskDtoResolver'] ?? $container->load('getTaskDtoResolverService'));
            ...
            'App\\DTOResolvers\\TaskDtoResolver' => ['privates', '.debug.value_resolver.App\\DTOResolvers\\TaskDtoResolver', 'getTaskDtoResolverService', true],
            'App\\DTOResolvers\\UserDtoResolver' => ['privates', '.debug.value_resolver.App\\DTOResolvers\\UserDtoResolver', 'getUserDtoResolverService', true],
     ...
     */
    protected static function get_CacheConnection_8zx_G5rService($container)
    {
        return $container->privates['.cache_connection.8zx.G5r'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('redis://localhost:6379', ['lazy' => true]);
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1RtwAm2yyX', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GiZwHiBmxZ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.8zx.G5r'] ?? self::get_CacheConnection_8zx_G5rService($container)), 'cksnM+0bRl', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RdfSRzexfB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.8zx.G5r'] ?? self::get_CacheConnection_8zx_G5rService($container)), 'IpmWicFRD8', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+VVQ+Y0yF-', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C2TZZhAGl9', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['doctrine.orm.default_annotation_metadata_driver'] = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($container->privates['annotations.cached_reader'] ?? $container->load('getAnnotations_CachedReaderService')), [(\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')], true);
    }
    ...
    {
        $container->privates['monolog.handler.error'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/dev.error.log'), 30, 'error', true, NULL, false);
     ...
     * @return \Monolog\Handler\RotatingFileHandler
     */
    protected static function getMonolog_Handler_InfoService($container)
    {
        $container->privates['monolog.handler.info'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/dev.info.log'), 30, 'info', true, NULL, false);
    ...
    {
        $container->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/dev.log'), 30, 'debug', true, NULL, false);
    ...
    /**
     * Gets the private 'monolog.handler.warning' shared service.
     *
     * @return \Monolog\Handler\RotatingFileHandler
     */
    protected static function getMonolog_Handler_WarningService($container)
    {
        $container->privates['monolog.handler.warning'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'log/dev.warning.log'), 30, 'warning', true, NULL, false);
    ...
    protected static function getMonolog_LoggerService($container)
    {
        ...
        $instance->pushHandler(($container->privates['monolog.handler.info'] ?? self::getMonolog_Handler_InfoService($container)));
        $instance->pushHandler(($container->privates['monolog.handler.warning'] ?? self::getMonolog_Handler_WarningService($container)));
     ...
     * @return \Symfony\Component\Cache\Adapter\TraceableAdapter
     */
    protected static function getMyRedisPoolService($container)
    {
        $a = new \Symfony\Component\Cache\Adapter\RedisAdapter(($container->privates['.cache_connection.8zx.G5r'] ?? self::get_CacheConnection_8zx_G5rService($container)), 'D4nmagpgLp', 0, ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));

        return $container->privates['my_redis_pool'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter($a);
    }
    ...
    protected static function getSecurity_ContextListener_0Service($container)
    {
        ...
        return $container->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Config\\Security\\UserProvider'] ?? $container->load('getUserProviderService'));
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'snc'.\DIRECTORY_SEPARATOR.'redis-bundle'.\DIRECTORY_SEPARATOR.'src/Resources/views'), '!SncRedis');
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gos'.\DIRECTORY_SEPARATOR.'web-socket-bundle/templates'), 'GosWebSocket');
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gos'.\DIRECTORY_SEPARATOR.'web-socket-bundle/templates'), '!GosWebSocket');
     ...
     */
    protected static function getGosPubsubRouter_RouterRegistryService($container)
    {
        ...
        return $container->get('.container.private.gos_pubsub_router.router_registry');
    }
     ...
     */
    protected static function getGosWebSocket_Client_ManipulatorService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.client.manipulator');
    }
     ...
     */
    protected static function getGosWebSocket_Dispatcher_RpcService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.dispatcher.rpc');
    }
     ...
     */
    protected static function getGosWebSocket_Dispatcher_TopicService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.dispatcher.topic');
    }
     ...
     */
    protected static function getGosWebSocket_Registry_PeriodicService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.registry.periodic');
    }
     ...
     */
    protected static function getGosWebSocket_Registry_OriginsService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.registry.origins');
    }
     ...
     */
    protected static function getGosWebSocket_Registry_RpcService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.registry.rpc');
    }
     ...
     */
    protected static function getGosWebSocket_Registry_ServerService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.registry.server');
    }
     ...
     */
    protected static function getGosWebSocket_Registry_TopicService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.registry.topic');
    }
     ...
     */
    protected static function getGosWebSocket_Server_LauncherService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.server.launcher');
    }
     ...
     */
    protected static function getGosWebSocket_Server_EventLoopService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.server.event_loop');
    }
     ...
     */
    protected static function getGosWebSocket_Topic_PeriodicTimerService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.topic.periodic_timer');
    }
     ...
     */
    protected static function getGosWebSocket_Wamp_TopicManagerService($container)
    {
        ...
        return $container->get('.container.private.gos_web_socket.wamp.topic_manager');
    }
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'lexik_jwt_authentication.token_ttl' => $container->getEnv('JWT_TOKEN_UTIL'),
            'mercure.hubs' => [
        ...
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'GosPubSubRouterBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gos'.\DIRECTORY_SEPARATOR.'pubsub-router-bundle'),
                    'namespace' => 'Gos\\Bundle\\PubSubRouterBundle',
                ],
                'GosWebSocketBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'gos'.\DIRECTORY_SEPARATOR.'web-socket-bundle'),
            ...
            'gos_web_socket.server.port' => 8080,
            'gos_web_socket.server.host' => '127.0.0.1',
