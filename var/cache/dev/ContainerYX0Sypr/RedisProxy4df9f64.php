...
class RedisProxy4df9f64 extends \Redis implements \Symfony\Component\VarExporter\LazyObjectInterface
{
    ...
    public function sRandMember(string $key, int $count = 0): \Redis|array|false|string
    {
        if (isset($this->lazyObjectState)) {
    ...
    public function zCount(string $key, string $start, string $end): \Redis|false|int
    {
        if (isset($this->lazyObjectState)) {
...
if (!\class_exists('RedisProxy4df9f64', false)) {
    \class_alias(__NAMESPACE__.'\\RedisProxy4df9f64', 'RedisProxy4df9f64', false);
}
