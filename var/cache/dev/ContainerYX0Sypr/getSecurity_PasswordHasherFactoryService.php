...
class getSecurity_PasswordHasherFactoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Config'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'UserPasswordEncoder.php';

        return $container->privates['security.password_hasher_factory'] = new \Symfony\Component\PasswordHasher\Hasher\PasswordHasherFactory(['App\\Config\\Security\\AuthenticateUser' => new \App\Config\Security\UserPasswordEncoder(), 'App\\Entity\\User' => ['class' => 'Symfony\\Component\\PasswordHasher\\Hasher\\NativePasswordHasher', 'arguments' => [NULL, NULL, NULL, '2y']]]);
    }
}
